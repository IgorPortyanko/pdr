...
export function TopBar() {
  ...
  return (
    <div
      className="app-topbar flex items-center flex-wrap gap-2 shrink-0 bg-paper"
      style={{ padding: '11px 16px', borderBottom: `1.5px solid var(--c-border)`, minHeight: 0 }}
    >
      <SignpostBig size={18} color="var(--c-accent)" />
      <span className="app-title shrink-0" style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: 20 }}>
        Правила дорожнього руху
      </span>

      <div className="app-profile-actions" style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 8 }}>
        <button
          onClick={toggle}
